# AWS Telco Network Builder MCP Server

This MCP (Model Content Protocol) server provides access to AWS Telco Network Builder API functionality through HTTP, HTTPS, and STDIO transport modes.
