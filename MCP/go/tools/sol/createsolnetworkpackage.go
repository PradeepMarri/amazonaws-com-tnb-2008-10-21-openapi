...
func CreatesolnetworkpackageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/sol/nsd/v1/ns_descriptors", cfg.BaseURL)
		...
		var result models.CreateSolNetworkPackageOutput
...
func CreateCreatesolnetworkpackageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_sol_nsd_v1_ns_descriptors",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatesolnetworkpackageHandler(cfg),
	}
}
